$(document).ready(function() {
    $(".btn_email").on('click', function() {        
        var input_id, email_val,pop_con;
        ...
        emailCheck(input_id, email_val, pop_con);
    });
...
//DB 이메일 체크
function emailCheck(input_id, email_val, pop_con) {
    var email = email_val;
...
//이메일 등록 성공 팝업 창
function openResultPop(pop_con){
    pop_con.children('.pop_email02').removeClass('hidden')
    pop_con.children('.pop_email01').addClass('hidden')
}
//이메일 전송
